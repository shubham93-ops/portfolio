...
def build_pdf(filename="assets/Ram_Sewak_Sharma_Resume.pdf"):
    ...
    # 1-page tight layout matching the approved resume
    ...
    def add_section_header(title):
        ...
        story.append(HRFlowable(width="100%", thickness=0.8, color=primary_color, spaceAfter=2.5, spaceBefore=1))

    # 3. PROFESSIONAL SUMMARY
    add_section_header("Professional Summary")
    summary_text = (
        "Cybersecurity professional specializing in Vulnerability Assessment and Penetration Testing (VAPT), Web Application Security, "
        "and Network Security. Hands-on experience across Linux and Windows environments conducting structured security assessments and "
        "identifying vulnerabilities aligned with OWASP Top 10, NIST, and SANS frameworks. Proficient with industry-standard penetration "
        "testing tools including Burp Suite, Nessus, Nmap, Wireshark, SQLMap, and Metasploit. Experienced in producing actionable, "
        "CVSS-based reports with clear remediation guidance across 5+ client engagements. Adept at security automation with Python and "
        "committed to ethical hacking and continuous security improvement."
    )
    ...
    story.append(Paragraph("Cyber Security Analyst – VAPT & Network Security &nbsp;|&nbsp; November 2025 – Present", job_meta_style))
    ...
    exp_bullets = [
        ...
        "• <b>Network Penetration Testing & Hardening</b>: Performed network infrastructure security assessments using Nmap, Wireshark, and Nessus across Linux and Windows environments; identified misconfigurations, open ports, and weak authentication mechanisms, delivering hardening recommendations aligned to NIST and SANS standards.",
        "• <b>CVSS Reporting & PoC Documentation</b>: Produced structured penetration testing reports for client engagements with CVSS-based severity ratings, proof-of-concept (PoC) documentation, and remediation steps, translating technical findings into actionable guidance for technical teams and stakeholders.",
        "• <b>Security Auditing & Compliance</b>: Assisted in scoping and executing security audits for client environments, eliminating false positives, verifying remediation patches, and assessing security posture per NIST and industry standards."
    ]
    ...
    # Project 3
    p3_title = "<b>Web, API & Network Penetration Testing Lab</b> — <i>Burp Suite, Nessus, Nmap, SQLMap, Wireshark, Metasploit, DVWA</i>"
    ...
    story.append(Paragraph("• Performed network reconnaissance and traffic analysis using Nmap, Wireshark, and Nessus on simulated targets; validated 15+ vulnerabilities and misconfigurations, authoring structured remediation recommendations.", bullet_style))
    story.append(Spacer(1, 2))
    ...
    skills = [
        "<b>Penetration Testing Tools</b>: Burp Suite, Nessus, Nmap, SQLMap, Metasploit, Wireshark, Gobuster, Dirsearch, Nuclei, Amass, Postman, Kali Linux",
        "<b>Security Disciplines</b>: Web Application Security, VAPT, API Security, Network Security, OWASP Top 10, Security Auditing, System Hardening",
        ...
        "<b>SIEM & Monitoring (Basic)</b>: Splunk, Wazuh, OpenVAS, Log Analysis, Incident Triage",
